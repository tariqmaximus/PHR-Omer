  ...
  sendEmail(){
    ...
    this.isLoading=true;
     ...
     wrapperSendEmail.from_name = this.lookupList.logedInUser.user_name;
       ...
       this.generalService.sendDirectMessage(formData).subscribe(
        data => {
          this.isLoading=false;
          if (data['status'] === ServiceResponseStatusEnum.SUCCESS) {
            this.GeneralOperation.updateLog("CCDA", this.lookupList.patientInfo.patient_id, "Transmit","Encrypted to "+emailsTo);
                 ...
                 this.email_response=data['response'];
        },
        error => {
          this.isLoading=false;
